...
[![](https://img.shields.io/badge/Latest%20Version-0.2.3-orange)](/spring-test-profiler-extension/pom.xml)
...
```groovy
testRuntimeOnly("digital.pragmatech.testing:spring-test-profiler:0.2.3")
```
